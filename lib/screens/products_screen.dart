...
class _ProductsScreenState extends ConsumerState<ProductsScreen> {
  ...
  Future<void> getProducts() async {
    final data = await ProdictService().getProducts();
  ...
  Widget build(BuildContext context) {
    final prdMngr = ref.watch(cartPrivider);
    return Scaffold(
      appBar: AppBar(
                            ...
                            Container(
                              ...
                              child: Padding(
                               padding: const EdgeInsets.symmetric(horizontal:4 , vertical: 2),
                                child: Text(double.parse( products[index].rating.toStringAsFixed(1)).toString()),
                              ))
                          ]),
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color: (prdMngr.cartItems.any((element) =>
                                            element.id ==
                                            products[index].id.toString()))
                                        ? Colors.green[400]
                                        : Colors.blue[200]),
                                child:  Center(child:  (prdMngr.cartItems.any((element) =>
                                              element.id ==
                                              products[index].id.toString())) ? const Text('Go To Cart')  : const Text("Add to Cart")),
                              ),
                            ),
                          )
                        ],
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                            ...
                                            color: (prdMngr.cartItems.any(
                                                ...
                                                : Colors.blue[200]),
                                        child:  Center(
                                            child: (prdMngr.cartItems.any((element) =>
                                              element.id ==
                                              products[index].id.toString())) ? const Text('Go To Cart')  : const Text("Add to Cart")),
                                      ),
                                    )
