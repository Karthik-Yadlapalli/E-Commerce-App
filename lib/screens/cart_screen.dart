...
class CartScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final cartMnrg = ref.watch(cartPrivider);
    return Scaffold(
      appBar: AppBar(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Text(double.parse( cartMnrg.cartItems[index].product.rating
                                    ...
                                    child: Row(
                                      children: [
                                        GestureDetector(
                                         ...
                                         SizedBox(
                                          width: 30,
                                          child: Center(child: Text(cartMnrg.cartItems[index].quantity.toString())),
                                        ),
                                        GestureDetector(
                                            onTap: () {
                                              cartMnrg.qDecrement(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      totalRow("GST (18%)", double.parse(cartMnrg.calculateGST().toStringAsFixed(2)).toString()),
                      totalRow("Total Amount", double.parse(cartMnrg.totalAmount().toStringAsFixed(2)).toString())
                    ],
                  ),
                ),
              ),
